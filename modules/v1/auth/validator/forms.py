...
class RegistrationForm(FlaskForm):
    ...
    email = wtf.StringField('Email', [wtf.validators.Email(message='EMAIL_INVALID'), wtf.validators.DataRequired(message='EMAIL_REQUIRED')])
    contact = wtf.IntegerField('Contact', validators=[DataRequired(message='NOT_VALID_FOR'),Length(min=7, max=15, message='CONTECT_MIM7_MAX15')])
